            ...
            <div class="panel-body">
                <div class="container-fluid">
                    ...
                    <div class="col-xs-6">
                        ...
                        <input value="<?php echo $_SESSION['telefono']; ?>" class="form form-control" id="telefono" name="telefono">
                    ...
                    <div class="col-xs-6">
                        ...
                        <input value="<?php echo $_SESSION['celular']; ?>" class="form form-control" id="celular" name="celular">
